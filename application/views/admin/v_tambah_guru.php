            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= base_url('administrator/tambahGuru') ?>" method="post">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" id="nip" name="nip" class="form-control ">
                                                <!-- pesan error -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="tmp_lahir" class="form-control" type="text" name="tmp_lahir">
                                                <!-- pesan error -->
