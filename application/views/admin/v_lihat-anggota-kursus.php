        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                                            ...
                                            foreach ($anggotaIdKursus as $k) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= base_url('administrator/hapusAnggotaKursus/') . $k['id_anggota'] . '/' . $k['id_kursus'] ?>" class="btn btn-danger tombol-hapus" data-toggle="tooltip" data-placement="bottom" title="Hapus"><i class="glyphicon glyphicon-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $i++;
                    ...
                    <a href="<?= base_url('administrator/detailKursus/') . $kursusId['id_kursus'] ?>" class="float-right btn btn-block btn-danger btn-sm">Kembali</a>
                </div>
            </div>
        </div>
...
<!-- modal tambah kelas -->
<form action="<?= base_url('administrator/tambahAnggota/') . $kursusId['id_kursus'] . '/' . $siswaId['id_kelas'] ?>" method="post">
