            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= base_url('administrator/uploadMateri/') . $sesiId['id_sesi'] . '/' . $kursusId['id_kursus'] ?>" method="post" enctype="multipart/form-data">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3">
                                            <div class="form-group">
                                                <label for="nama_file" class="text-danger">Nama File</label>
                                                ...
                                                <small class="">File yang di dukung doc, docx, pdf, xlsx, ppt,pptx, xls, mp4, 3gp, flv</small>
                                ...
                                <div class="card-footer text-center">
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            <a href="<?= base_url('administrator/lihatSesiKursus/') . $sesiId['id_sesi'] . '/' . $kursusId['id_kursus'] ?>" class="btn btn-danger" type="button">Batal</a>
