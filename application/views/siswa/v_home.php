        ...
        <div class="row">
            <div class="col-md-9 col-sm-9  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        Ini adalah halaman untuk Siswa
                    </div>
                </div>

                <?php if ($siswaBySession['tgl_lahir'] == '0000-00-00') : ?>
                    <div class="x_panel">
                        <div class="x_title">
            ...
            <div class="col-md widget widget_tally_box m-auto">
                    ...
                    <div class="x_content">
                        ...
                        <div class="flex">
                            <ul class="list-inline">
                                <li>
                                    <ul>
                                        <li>NIS : <?= $user['username'] ?></li>
                                        <li>No Hp : <?= $siswaBySession['tlp'] ?></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <p>
                            <?php if ($siswaBySession['tgl_lahir'] == '0000-00-00') : ?>
                                <a href="<?= base_url('siswa/editProfil/') . $siswaBySession['id_siswa'] ?>" class="btn btn-danger">Lengkapi Profil</a>
                            <?php else : ?>
